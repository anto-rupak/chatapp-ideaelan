    ...
    ChatContentPage.prototype.ionViewDidLeave = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.role == "providerAdmin")) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        if (!(this.role == "user")) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(this.role == "providerAdmin")) return [3 /*break*/, 4];
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 6];
                    case 4:
                        if (!(this.role == "user")) return [3 /*break*/, 6];
